...
public class K05_Klasa {
	...
	public static void main(String[] args) {
		...
		// String pb = JOptionPane.showInputDialog("Unesi ime1");
		// String db = JOptionPane.showInputDialog("Unesi ime2");
		// string concatenation
		// System.out.println(pb+db);

		// citanje dokumentacije

		// String ime = JOptionPane.showInputDialog("ime");
		String ime = "Osijek";
